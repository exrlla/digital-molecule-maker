                ...
                <table>
                    <tbody>
                        <tr>
                            ...
                            <td>
                                <div className='bar' style={{width: weight * 200 + "%"}}></div>
                            </td>
                        ...
                        <tr>
                            ...
                            <td>
                                <div className='bar' style={{width: light_absorption * 200 + "%"}}></div>
                            </td>
                        ...
                        <tr>
                            ...
                            <td>
                                <div className='bar' style={{width: lifespan * 200 + "%"}}></div>
                            </td>
                        ...
                        <tr>
                            ...
                            <td>
                                <div className='bar' style={{width: bandgap * 200 + "%"}}></div>
                            </td>
